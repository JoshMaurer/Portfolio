...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios
      .get(`https://anturio.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {withCredentials: true
      })
      .then(response => {
        console.log('getting', response.data);
        // debugger; use this to get number of page/records in the db. records needed for infinate scroll
        this.setState({
    ...
    return (
      <div className='blog-container'>
        ...
        <div className='content-loader'>
          <FontAwesomeIcon icon='scissors' spin />
        </div>) : null}
